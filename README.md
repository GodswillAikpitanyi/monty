...
### Resources:books:
Read or watch:
* [Google](https://www.google.com/search?q=stack+and+queue&sxsrf=ALiCzsYxJOJRwq7k3CCA4Z-pDIGpY3_APQ%3A1670965783846&source=hp&ei=F-qYY8HMMIHvsAeqkb_IAg&iflsig=AJiK0e8AAAAAY5j4J-8GeeiezA4OXEfWMokWTrK4yLM_&ved=0ahUKEwiBtObPwPf7AhWBN-wKHarIDykQ4dUDCBA&oq=stack+and+queue&gs_lcp=Cgdnd3Mtd2l6EAxQAFgAYABoAHAAeACAAQCIAQCSAQCYAQA&sclient=gws-wiz)
...
| stack_func.c |  Contains functions create stack and queues: ***_push, _pall, _swap,***
...
* **Godswill Aikpitanyi** - [GodswillAikpitanyi](https://github.com/Godswillaikpitanyi)
